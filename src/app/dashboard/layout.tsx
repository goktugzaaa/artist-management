...
export default async function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen bg-canvas">
      <aside className="sticky top-0 flex h-screen w-64 flex-col justify-between border-r border-line bg-surface px-4 py-5">
        <div>
      ...
      <main className="flex-1">
        {!configured && (
          <div className="border-b border-line bg-accent-soft px-8 py-2 text-xs text-accent-ink">
